...
vlog -vlog01compat -work work +incdir+$ip_road/sys_clk125m_gen $ip_road/sys_clk125m_gen/sys_clk125m_gen.vo
vlib sys_clk125m_gen
vmap sys_clk125m_gen sys_clk125m_gen
vlog -vlog01compat -work sys_clk125m_gen +incdir+$ip_road/sys_clk125m_gen $ip_road/sys_clk125m_gen/sys_clk125m_gen.v
vlog -vlog01compat -work work +incdir+$ip_road/sys_clk60m_gen/sys_clk60m_gen $ip_road/sys_clk60m_gen/sys_clk60m_gen/sys_clk60m_gen.vo
vlib sys_clk60m_gen
vmap sys_clk60m_gen sys_clk60m_gen
vlog -vlog01compat -work sys_clk60m_gen +incdir+$ip_road/sys_clk60m_gen/sys_clk60m_gen $ip_road/sys_clk60m_gen/sys_clk60m_gen/sys_clk60m_gen.v



vlog -work work ../../src/pc_transfer_top/*.v
vlog -work work ../../src/pc_transfer_top/*/*.v
vlog -work work ../../src/inter_cfg_top/*.v
vlog -work work ../../src/common_block/*.v
vlog -work work ../../ip/fifo*/fifo_*_st.v
vlog -work work ../../ip/fifo*/fifo_*_fwft.v
vlog -work work ../../ip/sdpram*/sdpram_d4kw8.v
