...
# ACDS 14.1 186 win32 2020.08.11.19:31:24
...
TOP_LEVEL_NAME="clkctr_s"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="I:/intel/14_1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/submodules/clkctr_s_altclkctrl_0.v" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvlog "$QSYS_SIMDIR/clkctr_s.v"                                                                                   
fi
