...
# ACDS 14.1 186 win32 2020.08.11.19:33:02
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/submodules/clkctr_altclkctrl_0.v" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvlog "$QSYS_SIMDIR/clkctr.v"                                                                                   
fi
