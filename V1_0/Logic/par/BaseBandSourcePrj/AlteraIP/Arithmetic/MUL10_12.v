...
module  MUL10_12_altera_mult_add_2f4g
	( 
	aclr0,
	clock0,
	dataa,
...
`endif
	...
	defparam
		...
		altera_mult_add_rtl2.width_a = 12,
	...
	assign
		result = wire_altera_mult_add_rtl2_result;
endmodule //MUL10_12_altera_mult_add_2f4g

//synthesis_resources = altera_mult_add_rtl 1 dsp_mac 1 reg 22 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  MUL10_12_mult_add_brt1
	( 
	aclr0,
	clock0,
	dataa,
...
`endif
	...
	MUL10_12_altera_mult_add_2f4g   altera_mult_add1
	( 
	.aclr0(aclr0),
	.clock0(clock0),
	.dataa(dataa),
	...
	assign
		...
		ena3 = 1'b1,
		result = wire_altera_mult_add1_result;
endmodule //MUL10_12_mult_add_brt1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  MUL10_12_altera_mult_add_1e4g
	( 
	aclr0,
	clock0,
	dataa,
...
`endif
	...
	wire  [21:0]   wire_altera_mult_add_rtl4_result;
	...
	defparam
		...
		altera_mult_add_rtl4.width_a = 12,
		...
		altera_mult_add_rtl4.width_result = 22,
	...
	assign
		result = wire_altera_mult_add_rtl4_result;
endmodule //MUL10_12_altera_mult_add_1e4g

//synthesis_resources = altera_mult_add_rtl 1 dsp_mac 1 reg 22 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  MUL10_12_mult_add_aqt1
	( 
	aclr0,
	clock0,
	dataa,
...
`endif
	...
	wire  [21:0]   wire_altera_mult_add3_result;
	wire ena1;
	wire ena2;
	wire ena3;

	MUL10_12_altera_mult_add_1e4g   altera_mult_add3
	( 
	.aclr0(aclr0),
	.clock0(clock0),
	.dataa(dataa),
	...
	assign
		...
		ena3 = 1'b1,
		result = wire_altera_mult_add3_result;
endmodule //MUL10_12_mult_add_aqt1

//synthesis_resources = altera_mult_add_rtl 2 dsp_mac 2 reg 88 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  MUL10_12_altmult_complex_d1p
	( 
	clock,
	dataa_imag,
	dataa_real,
	...
	output   [21:0]  result_imag;
	output   [21:0]  result_real;
`ifndef ALTERA_RESERVED_QIS
// synopsys translate_off
`endif
	tri0   clock;
...
`endif
	...
	wire  [21:0]   wire_mult_add1_result;
	wire  [21:0]   wire_mult_add2_result;
	reg	[21:0]	result_imag0c;
	reg	[21:0]	result_real0c;
	wire aclr;
	wire ena;
	wire  [23:0]  mult_add1_inputa;
	wire  [19:0]  mult_add1_inputb;
	wire  [19:0]  mult_add2_inputb;

	MUL10_12_mult_add_brt1   mult_add1
	( 
	.aclr0(aclr),
	.clock0(clock),
	...
	MUL10_12_mult_add_aqt1   mult_add2
	( 
	.aclr0(aclr),
	.clock0(clock),
	.dataa(mult_add1_inputa),
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) result_imag0c <= 22'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) result_real0c <= 22'b0;
		else if  (ena == 1'b1)   result_real0c <= wire_mult_add1_result;
	assign
		aclr = 1'b0,
		ena = 1'b1,
		mult_add1_inputa = {dataa_imag[11:0], dataa_real[11:0]},
...
endmodule //MUL10_12_altmult_complex_d1p
//VALID FILE
...
module MUL10_12 (
	...
	wire [21:0] sub_wire0;
	wire [21:0] sub_wire1;
	wire [21:0] result_imag = sub_wire0[21:0];
	wire [21:0] result_real = sub_wire1[21:0];

	MUL10_12_altmult_complex_d1p	MUL10_12_altmult_complex_d1p_component (
				.clock (clock),
...
// Retrieval info: USED_PORT: result_imag 0 0 22 0 OUTPUT NODEFVAL "result_imag[21..0]"
// Retrieval info: USED_PORT: result_real 0 0 22 0 OUTPUT NODEFVAL "result_real[21..0]"
...
// Retrieval info: CONNECT: result_imag 0 0 22 0 @result_imag 0 0 22 0
// Retrieval info: CONNECT: result_real 0 0 22 0 @result_real 0 0 22 0
// Retrieval info: GEN_FILE: TYPE_NORMAL MUL10_12.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL MUL10_12.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL MUL10_12.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL MUL10_12.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL MUL10_12_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL MUL10_12_bb.v FALSE
