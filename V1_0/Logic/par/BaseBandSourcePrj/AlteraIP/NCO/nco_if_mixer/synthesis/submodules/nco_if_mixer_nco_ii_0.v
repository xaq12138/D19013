...
module nco_if_mixer_nco_ii_0(clk, reset_n, clken, phi_inc_i, freq_mod_i, phase_mod_i, fsin_o, fcos_o, out_valid);
...
parameter raw = 16;
parameter rnw = 0;
parameter rsf = "nco_if_mixer_nco_ii_0_sin.hex";
parameter rcf = "nco_if_mixer_nco_ii_0_cos.hex";
parameter nc = 1;
parameter log2nc =0;
...
assign phi_acc_w_pmi[aprp-1:aprp-aprid] = phi_acc_w_d[aprid-1:0];
assign phi_acc_w_pmi[10] = 1'b0;
assign phi_acc_w_pmi[9] = 1'b0;
assign phi_acc_w_pmi[8] = 1'b0;
assign phi_acc_w_pmi[7] = 1'b0;
assign phi_acc_w_pmi[6] = 1'b0;
assign phi_acc_w_pmi[5] = 1'b0;
assign phi_acc_w_pmi[4] = 1'b0;
assign phi_acc_w_pmi[3] = 1'b0;
assign phi_acc_w_pmi[2] = 1'b0;
assign phi_acc_w_pmi[1] = 1'b0;
assign phi_acc_w_pmi[0] = 1'b0;
