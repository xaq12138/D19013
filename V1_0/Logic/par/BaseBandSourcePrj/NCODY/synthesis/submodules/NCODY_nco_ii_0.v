...
module NCODY_nco_ii_0(clk, reset_n, clken, phi_inc_i, freq_mod_i, phase_mod_i, fsin_o, fcos_o, out_valid);
...
parameter rsfc = "NCODY_nco_ii_0_sin_c.hex";
parameter rsff = "NCODY_nco_ii_0_sin_f.hex";
parameter rcfc = "NCODY_nco_ii_0_cos_c.hex";
parameter rcff = "NCODY_nco_ii_0_cos_f.hex";
parameter nc = 1;
parameter log2nc =0;
